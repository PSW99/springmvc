...
public class RequestBodyJsonController {
    ...
    private String requestBodyJsonV3(@RequestBody HelloData helloData){
    ...
    private String requestBodyJsonV4(HttpEntity<HelloData> data) {
    ...
    private HelloData requestBodyJsonV5(@RequestBody HelloData data) {
